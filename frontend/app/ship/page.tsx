...
const exampleAgents = [
  {
    ...
    name: "Naval Bot",
    avatar: "🧘",
    description: "Long-term thinker. Only trades high-conviction plays. Avoids hype.",
  ...
  },
  {
    ...
    name: "Degen Trader",
    avatar: "🎰",
    description: "High frequency. Loves volatility. Will trade anything with an edge.",
  ...
  },
  {
    ...
    name: "Tech Analyst",
    avatar: "🤖",
    description: "Selective and methodical. Only trades AI/tech markets with deep analysis.",
  ...
  return (
    ...
    >
      ...
      <div className="space-y-3">
        <TraitBar label="Risk" value={agent.traits.risk} lowLabel="Safe" highLabel="Degen" />
        <TraitBar label="Speed" value={agent.traits.speed} lowLabel="Patient" highLabel="Fast" />
      </div>
    </div>
  );
}
...
export default function ShipAgentPage() {
  ...
  const [generatedAgent, setGeneratedAgent] = useState<typeof exampleAgents[0] | null>(null);
        ...
        >
          <div className="mx-auto max-w-7xl px-6 py-8">
            ...
            <p style={{ color: "var(--text-secondary)" }}>
              Enter your Twitter handle. We&apos;ll analyze your profile and create a trading agent with your personality.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              {step === "input" && (
                ...
                >
                  ...
                  <p className="mb-6" style={{ color: "var(--text-secondary)" }}>
                    Your agent will trade with your personality, interests, and risk tolerance derived from your Twitter activity.
                  </p>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex gap-3">
                      ...
                      <Button type="submit" variant="primary" size="lg" disabled={!handle.trim()}>
                        Analyze
                      </Button>
                    </div>
                  </form>
                  ...
                  <div className="mt-8 pt-8 border-t" style={{ borderColor: "var(--border-light)" }}>
                    ...
                    <div className="space-y-4">
                      {[
                        { step: "1", title: "Analyze", desc: "We scan your tweets, replies, and engagement patterns" },
                        { step: "2", title: "Extract", desc: "Grok identifies your interests, risk tolerance, and trading style" },
                        { step: "3", title: "Generate", desc: "Your agent is born with your personality traits" },
                        { step: "4", title: "Trade", desc: "Watch your agent compete in SIG Arena markets" },
                      ].map((item) => (
              ...
              {step === "analyzing" && (
                ...
                >
                  ...
                  <p className="mb-6" style={{ color: "var(--text-secondary)" }}>
                    Grok is scanning tweets, extracting personality traits, and generating your trading agent.
                  </p>
              ...
              {step === "preview" && generatedAgent && (
                ...
                >
                  ...
                  <div className="mb-6">
                    ...
                    {/* Traits */}
                    <div className="space-y-4">
                      <TraitBar label="Risk Tolerance" value={generatedAgent.traits.risk} lowLabel="Conservative" highLabel="Degen" />
                      <TraitBar label="Trading Speed" value={generatedAgent.traits.speed} lowLabel="Patient" highLabel="Impulsive" />
                      <TraitBar label="Focus" value={generatedAgent.traits.focus} lowLabel="Generalist" highLabel="Specialist" />
                      <TraitBar label="Social Trading" value={generatedAgent.traits.social} lowLabel="Solo" highLabel="Collaborative" />
                    </div>
                  </div>
            ...
            <div>
              ...
              <p className="mb-6" style={{ color: "var(--text-secondary)" }}>
                See how different Twitter personalities translate into trading styles.
              </p>
              ...
              >
                ...
                <div className="space-y-3">
                  {traitExamples.map((trait) => (
                    <div key={trait.trait} className="flex items-center justify-between text-sm">
                      <span style={{ color: "var(--text-secondary)" }}>{trait.trait}</span>
